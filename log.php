...
if(isset($_POST['submit'])){
    ...
    $select = "SELECT * FROM info WHERE email = '$email' && password = '$pass' ";
    ...
    }else
    {
    	...
    	{
    		$insert = "INSERT INTO info (username, email, password,user_type) VALUES('$name','$email','$pass','$user_type')";
...
if(isset($_POST['lsubmit'])){
    ...
    $select = "SELECT * FROM info WHERE username = '$name' && password = '$pass' ";
	  ...
	  <div class="hero">
	      <div class="form-box">
		       <div class="button-box">
				...
				<form action="log.php" method="post" id="register"class="input-group">
					<?php
					if(isset($error))
					{
			   ...
			   <form action="log.php" method="post" id="login" class="input-group">
			   	<?php
					...
					?>
			   <input type="text" name="lname" class="input-field" placeholder="User Id" required>
			   <input type="password" name="lpassword" class="input-field" placeholder="Enter Password" required>
			   <select name="user_type">
			    	 <option value="user">User</option>
			    	 <option value="admin">Admin</option>
			    </select>
